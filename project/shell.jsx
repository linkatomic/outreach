// shell.jsx — sidebar, topbar, command palette, notifications, shortcuts

const { useState, useEffect, useMemo, useRef, useCallback } = React;

// ────────────────────── Sidebar ──────────────────────
function Sidebar({ route, setRoute, role, me, openCmdK, todayDone }) {
  const navItems = [
...
// ────────────────────── Topbar ──────────────────────
function Topbar({ route, role, setRole, theme, toggleTheme, openCmdK, openNotif, notifOpen, setNotifOpen }) {
  const crumbs = {
...
// ────────────────────── Command Palette ──────────────────────
function CommandPalette({ open, onClose, setRoute, openModal, role }) {
        ...
        {groups.map(g => (
          <div className="card" key={g.title}>
            ...
            <div className="card-pad">
              <div className="shc" style={{ display: 'flex', flexDirection: 'column' }}>
                {g.items.map(([l, k], i) => (
...
Object.assign(window, { Sidebar, Topbar, CommandPalette, Toast, ShortcutsPage });
